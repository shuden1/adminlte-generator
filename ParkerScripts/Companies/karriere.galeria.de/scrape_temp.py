...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_blocks = driver.find_elements(By.CSS_SELECTOR, 'a[href*="job"], a[href*="career"], a[href*="opening"], a[href*="position"], a[href*="vacancy"], a[href*="stellenangebot"], a[href*="karriere"]')
        
        for job_block in job_blocks:
            title = job_block.text
