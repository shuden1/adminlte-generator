...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'a.list-group-item[itemscope][itemtype="http://schema.org/JobPosting"]')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'h2.career-title[itemprop="title"]')
