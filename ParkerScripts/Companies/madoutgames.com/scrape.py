...
def scrape_jobs(file_path):
    ...
    job_blocks = driver.find_elements(By.CSS_SELECTOR, 'details')
    for job_block in job_blocks:
        summary_tag = job_block.find_element(By.CSS_SELECTOR, 'summary')
        job_title = summary_tag.text.strip()
        job_url = None
        if job_block.find_elements(By.CSS_SELECTOR, 'a'):
