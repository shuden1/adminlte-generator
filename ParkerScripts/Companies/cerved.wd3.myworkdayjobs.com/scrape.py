...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_blocks = driver.find_elements(By.CSS_SELECTOR, 'div[data-automation-id="jobSearchPage"]')

        for block in job_blocks:
            title_tags = block.find_elements(By.CSS_SELECTOR, 'a[data-automation-id="jobTitle"]')
