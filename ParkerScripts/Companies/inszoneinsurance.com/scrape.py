...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.item_positions.grid-item")
        for job_element in job_elements:
            ...
            try:
                ...
                job_url = url_element.get_attribute('href').strip() if url_element.get_attribute('href') else "#"
            except NoSuchElementException:
                pass
