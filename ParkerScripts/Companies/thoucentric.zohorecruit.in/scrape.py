...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'div.cw-filter-joblist[click="career-website-job-layout3 => clickJob(this)"]')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'a.cw-3-title.cw-bw[style="color:#F78848"]')
