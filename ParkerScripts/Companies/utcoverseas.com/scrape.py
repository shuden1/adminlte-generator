...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.fl-callout.fl-callout-has-icon.fl-callout-icon-above-title")

        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "h3.fl-callout-title a.fl-callout-title-link.fl-callout-title-text")
