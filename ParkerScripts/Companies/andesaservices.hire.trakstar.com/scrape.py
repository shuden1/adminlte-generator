...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.js-card.list-item.list-item-clickable.js-careers-page-job-list-item")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "h3.rb-h3.js-job-list-opening-name.cut-text.rb-text-color-primary.rb-space-on-bottom-2rbpx")
