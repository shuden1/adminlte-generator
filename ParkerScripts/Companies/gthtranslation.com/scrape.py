...
def scrape_jobs(file_path):
    ...
    job_listings = []
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.thjmf-job-listings-list.thjmf-listing-loop-content.list-wrapper")
        for job_element in job_elements:
            ...
            try:
                url_element = job_element.find_element(By.CSS_SELECTOR, "button.thjmf_apply_now.thjmf-btn-apply-now.gth-apply")
