...
def scrape_jobs(file_name):
    ...
    try:
        ...
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.Accordion--content--inner")

        for job_element in job_elements:
            try:
                job_title_element = job_element.find_element(By.CSS_SELECTOR, "td > a[rel='noreferrer noopener'][target='_blank']")
