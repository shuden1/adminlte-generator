...
def scrape_job_listings(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "article.group.post-8615.page.type-page.status-publish.has-post-thumbnail.hentry")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "h3.fittexted_for_content_h3")
