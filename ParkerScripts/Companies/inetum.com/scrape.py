...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.node.node-job.node-teaser")
        for job_element in job_elements:
            ...
            try:
                url_element = job_element.find_element(By.CSS_SELECTOR, "a.btn.btn-link.icons8-right-arrow")
