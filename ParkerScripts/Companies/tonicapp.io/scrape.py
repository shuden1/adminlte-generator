...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_elements = driver.find_elements(By.CSS_SELECTOR, "li.relative.mb-5.md\\:mb-8.job-offer")

        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "span.block.pb-1.font-medium.leading-5.text-downy.text-5.tracking-05")
