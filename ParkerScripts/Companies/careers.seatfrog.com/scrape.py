...
def scrape_jobs(file_path):
    ...
    try:
        ...
        try:
            job_elements = driver.find_elements(By.CSS_SELECTOR, 'li.block-grid-item')
            for job_element in job_elements:
                try:
                    title_element = job_element.find_element(By.CSS_SELECTOR, 'a span.text-block-base-link')
