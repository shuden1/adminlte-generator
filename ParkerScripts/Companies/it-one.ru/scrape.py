...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.onehire__table__tr")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "a.green-hover.onehire__table__td.onehire__table__td-hovered.onehire__table__td-2.middle-line[data-sign='Должность']")
