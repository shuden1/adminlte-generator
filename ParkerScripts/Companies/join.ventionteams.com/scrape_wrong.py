...
def scrape_jobs(file_path):
    ...
    job_blocks = driver.find_elements(By.CSS_SELECTOR, 'div.css-bz3ry3')

    job_openings = []
    for job_block in job_blocks:
        title_tag = job_block.find_element(By.CSS_SELECTOR, 'a')
        job_title = title_tag.find_element(By.CSS_SELECTOR, 'div.css-gfi4xx span.css-prn0qn').text.strip()
