...
def scrape_jobs(file_path):
    ...
    try:
        ...
        for job_element in job_elements:
            ...
            try:
                url_element = job_element.find_element(By.CSS_SELECTOR, "a.flex.flex-col.py-6.text-center.sm\\:px-6.hover\\:bg-gradient-block-base-bg.focus-visible-company.focus-visible\\:rounded[data-turbo=\"false\"]")
