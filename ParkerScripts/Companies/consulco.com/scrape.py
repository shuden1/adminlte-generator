...
def scrape_job_listings(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "a.row.the-post.post-9130.vacancies.type-vacancies.status-publish.has-post-thumbnail.hentry.location-cyprus")
        for job_element in job_elements:
            try:
                job_title_element = job_element.find_element(By.CSS_SELECTOR, "h3")
