...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "a.industry-flex.grey-block.job-tile.w-inline-block")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "h3.industry-title.green.margin-fix-ss.line-fix-ss")
