...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.joboffer.sppb-col-lg-3.sppb-col-md-6.sppb-col-sm-6.sppb-col-xs-12")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "h3 a[itemprop='url']")
