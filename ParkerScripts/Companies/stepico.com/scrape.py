...
def scrape_jobs(file_name):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'a.vacancy.grid-item-3.all[data-aos="fade-up"]')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'h3.h5')
