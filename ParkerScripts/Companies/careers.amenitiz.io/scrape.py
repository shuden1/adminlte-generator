...
def scrape_jobs(file_path):
    ...
    for job in job_openings:
        ...
        try:
            url_element = job.find_element(By.CSS_SELECTOR, "a.min-h-[180px].h-full.w-full.p-4.flex.flex-col.justify-center.text-center.hover:bg-block-base-text.hover:bg-opacity-30")
