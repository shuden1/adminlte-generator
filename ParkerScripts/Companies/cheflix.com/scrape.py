...
def scrape_jobs(file_path):
    ...
    job_opening_selector = 'article.elementor-post'
    job_title_selector = 'div.elementor-heading-title'
    job_url_selector = 'div.ecs-link-wrapper'
    ...
    for job in job_elements:
        ...
        url = job.find_element(By.CSS_SELECTOR, job_url_selector).get_attribute('data-href')
