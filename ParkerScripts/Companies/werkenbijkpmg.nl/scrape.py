...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "li.vacancy-list__item[x-html='result.listItem']")
        for job_element in job_elements:
            ...
            try:
                url_element = job_element.find_element(By.CSS_SELECTOR, "a[alter-data-gtm='vacancyClicked']")
