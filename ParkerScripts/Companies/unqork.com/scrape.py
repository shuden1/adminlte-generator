...
def scrape_jobs(file_path):
    ...
    try:
        job_openings = driver.find_elements(By.CSS_SELECTOR, "div.opening[data-department-4035919002='true'][data-department-4077244002='true'][data-office-4041254002='true']")
        for job in job_openings:
            try:
                title_element = job.find_element(By.CSS_SELECTOR, "a[data-mapped='true']")
