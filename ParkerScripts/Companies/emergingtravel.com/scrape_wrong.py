...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_opening_selector = '.career-departments-wrapper'
        job_title_selector = '.career-departments-item-title span'
        job_url_selector = 'a'
        ...
        for job_element in job_elements:
            ...
            title_element = url_element.find_element(By.CSS_SELECTOR, job_title_selector)
