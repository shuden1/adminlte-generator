...
def scrape_jobs(html_file_path):
    ...
    job_opening_selector = 'ul.dvinci-job-list > li'
    job_title_selector = 'h3.dvinci-job-position'
    job_url_selector = 'a.dvinci-job-entry'
    ...
    return json.dumps(job_postings, ensure_ascii=False, indent=4)
