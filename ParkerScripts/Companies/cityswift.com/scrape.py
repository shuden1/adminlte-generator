...
def scrape_jobs(html_file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'div.opening[data-department-4022807003="true"][data-office-4012112003="true"]')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'a[data-mapped="true"]')
