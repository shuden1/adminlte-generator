...
def scrape_jobs(html_file_path):
    ...
    try:
        ...
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.jobs-main-jobs-row-job[data-location][data-visible][style]")

        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "a[href]")
