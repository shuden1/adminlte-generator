...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_elements = driver.find_elements(By.CSS_SELECTOR, "tr.sfitem.sflistitem.sfClearfix[data-sf-id][data-sf-provider][data-sf-type]")
        
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "a[data-sf-field='Title'][data-sf-ftype='ShortText']")
