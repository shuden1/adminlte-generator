...
def scrape_job_listings(file_name):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'a.open-positions-block__single-position')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'span.open-positions-block__single-position-title')
