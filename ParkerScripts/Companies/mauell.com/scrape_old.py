...
def scrape_jobs(file_path):
    ...
    try:
        ...
        job_blocks = driver.find_elements(By.CSS_SELECTOR, 'div.careers__career')
        
        job_openings = []
        for job_block in job_blocks:
            job_link_tag = job_block.find_element(By.CSS_SELECTOR, 'a.careers__link')
            job_title_tag = job_block.find_element(By.CSS_SELECTOR, 'span.careers__title')
