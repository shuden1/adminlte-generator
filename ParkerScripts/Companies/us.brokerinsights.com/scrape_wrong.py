...
def scrape_jobs(file_path):
    ...
    try:
        ...
        try:
            job_elements = driver.find_elements(By.CSS_SELECTOR, "section.ctn.jobbottomfrm")
            for job_element in job_elements:
                try:
                    title_element = job_element.find_element(By.CSS_SELECTOR, "span.EOP.SCXW134667235.BCX0")
