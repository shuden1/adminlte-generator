...
def scrape_jobs(file_path):
    ...
    job_elements = driver.find_elements(By.CSS_SELECTOR, "div.joboffer_container")

    for job_element in job_elements:
        title_element = job_element.find_element(By.CSS_SELECTOR, "div.joboffer_title_text.joboffer_box > a")
