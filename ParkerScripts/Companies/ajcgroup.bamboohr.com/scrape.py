...
def scrape_jobs(html_file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.fabric-5qovnk-root.MuiBox-root.css-7ebljt")
        for job_element in job_elements:
            try:
                job_title_element = job_element.find_element(By.CSS_SELECTOR, "a.jss-f72")
