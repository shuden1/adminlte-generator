...
def scrape_job_listings(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "li.VacanciesList_vacancies-list__item__4XU8K")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "span.VacanciesList_vacancies-list__name__8Hqcl")
