...
def scrape_jobs(file_path):
    ...
    job_blocks = driver.find_elements(By.CSS_SELECTOR, 'div[class*="vacancy"]')
    for job_block in job_blocks:
        job_title_tag = job_block.find_element(By.CSS_SELECTOR, 'h2')
        job_url_tag = job_block.find_element(By.CSS_SELECTOR, 'a')
