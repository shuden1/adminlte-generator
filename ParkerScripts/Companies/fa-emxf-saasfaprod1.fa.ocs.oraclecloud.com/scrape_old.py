...
def scrape_jobs(file_path):
    ...
    job_opening_selector = 'ul.jobs-list__list li[data-qa="searchResultItem"]'
    ...
    for job_element in job_elements:
        ...
        title = title_element.get_attribute('innerText').strip().split('\n')[0]  # Extract only the job title
