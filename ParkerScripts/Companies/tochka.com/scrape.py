...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.jobs_jobsListItem__z2T4u.card_card__AZfzd.bc-grey100.crs-pointer")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "div.jobs_jobsListItemName__kDxIm")
