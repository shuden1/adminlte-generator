...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, 'a.border_bottom.font_6_grey.job_row.job_apply_link[style="display: block"][target="_blank"]')
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, 'span.font_18.vega-default-link')
