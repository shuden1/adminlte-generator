...
def scrape_jobs(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.relative.grid.h-full.content-between.border-t-8.border-solid.border-orange-500.bg-white.p-8.shadow")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "p.title-6.font-bold.leading-6")
