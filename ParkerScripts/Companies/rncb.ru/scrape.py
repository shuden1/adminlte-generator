...
def scrape_jobs(file_path):
    ...
    try:
        job_openings = driver.find_elements(By.CSS_SELECTOR, "div.link-card__head")
        for job_opening in job_openings:
            try:
                job_title_element = job_opening.find_element(By.CSS_SELECTOR, "h3.brand-title.brand-title_color-gray-800.brand-title_level-3.link-card__title")
