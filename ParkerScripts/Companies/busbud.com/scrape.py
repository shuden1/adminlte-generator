...
def scrape_job_listings(file_path):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "div.openings-section-module--table-row--a9bb9")
        for job_element in job_elements:
            try:
                title_element = job_element.find_element(By.CSS_SELECTOR, "a.bb-label.lg.bb-link.underline-always.openings-section-module--item-link--f0dd8.bold")
