...
def scrape_jobs(file_name):
    ...
    try:
        job_elements = driver.find_elements(By.CSS_SELECTOR, "li.mega-menu-item.mega-menu-item-type-post_type.mega-menu-item-object-page")
        for job_element in job_elements:
            try:
                job_title_element = job_element.find_element(By.CSS_SELECTOR, "a.mega-menu-link")
